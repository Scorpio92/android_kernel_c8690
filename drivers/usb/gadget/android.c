...
/*modify by devin.yuan for modify LUNS*/
#define DEF_LUNS	2
#else
#define DEF_LUNS	1
#endif
					...
					struct usb_composite_dev *cdev)
{
	...
	config->fsg.nluns = DEF_LUNS;
	for(i=0;i<DEF_LUNS;i++)
...
// Cellon modify start, Ted Shi, 2012/11/30, for change USB serial
//	strncpy(serial_string, "0123456789ABCDEF", sizeof(serial_string) - 1);
	strncpy(serial_string, "FA242463F56EA34E", sizeof(serial_string) - 1);
// Cellon modify end, Ted Shi, 2012/11/30
	id = usb_string_id(cdev);
	if (id < 0)
		return id;
