...
//Cellon add start, Eagle.Yin, 2012/11/26, for WiFi can't open, low probability
#include <linux/delay.h>
//Cellon add end, Eagle.Yin, 2012/11/26, for WiFi can't open, low probability
...
char mac_addrs[MOD_PARAM_PATHLEN];
...
// Cellon add start, Ted Shi, 2012/10/13, for wifi eng mode
//module_param_string(nvram_path, nvram_path, MOD_PARAM_PATHLEN, 0);
module_param_string(nvram_path, nvram_path, MOD_PARAM_PATHLEN, 0660);
// Cellon add end, Ted Shi, 2012/10/13

// Cellon add start, Ted Shi, 2012/10/20, for add wifi MAC
module_param_string(mac_addrs, mac_addrs, MOD_PARAM_PATHLEN, 0660);
// Cellon add end, Ted Shi, 2012/10/20
...
// Cellon add start, Ted Shi, 2012/10/20, for add wifi MAC
	/* Update wifi mac if it was changed */
	if ((mac_addrs != NULL) && (mac_addrs[0] != '\0')) {
		if (mac_addrs[strlen(mac_addrs)-1] == '\n')
			mac_addrs[strlen(mac_addrs)-1] = '\0';
			strcpy(mac_addr, mac_addrs);
			mac_addrs[0] = '\0';
	}
// Cellon add end, Ted Shi, 2012/10/20
