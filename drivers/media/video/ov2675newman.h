...
0x3086 ,0x00,             
	...
	static unsigned short ov2675_init_reg_short01113[]={
	0x3012,0x80, 
0x308c,0x80, 
0x308d,0x0e, 
0x360b,0x00, 
...
static unsigned short ov2675_init_reg_short08680[]={
...
static unsigned short ov2675_init_reg_short0dbgg[]={ //not black,the best 
0x3012,0x80,//software reset
0x308c,0x80,
0x308d,0x0e,
0x360b,0x00,
0x30b0,0xff,
...
//UVadjust
0x3301,0xff,
0x338B,0x12,//control color in low level 0c-0x11
0x338c,0x30,
0x338d,0x40,
//Sharpness/De-noise
0x3370,0xd0,
...
0x3026,0x02, // VH = 1212
0x3027,0x5e, // VH
0x3088,0x03, // ISP XOUT = 1280
0x3089,0x20, // ISP XOUT
0x308a,0x02, // ISP YOUT = 960
0x308b,0x58, // ISP YOUT
0x3310,0x65, //ispHi 1624
0x3311,0x4b, //ispvi 1212
0x3312,0xc8, //v/h
0x3313,0x00,
0x3314,0x00,
0x3315,0x00,
0x3316,0x64, // Scale X input = 1600
0x3317,0x25, // Scale Y input = 1200
0x3318,0x80, // Scale Y/X input
0x3319,0x04, // Scale X offset = 2/2
0x331a,0x64, // Scale X output = 1280
0x331b,0x4b, // Scale Y output = 960
0x331c,0x00, // Scale Y/X output
0x331d,0x38, // Scale Y offset = 4, Scale X offset = 4
0x3028,0x07, //hts =1939
0x3029,0x93, //hts
0x302a,0x02, // VTS = 1236
0x302b,0xe6, // VTS
0x302c,0x00, // EXHTS = 0
0x302d,0x00, // EXVTS = 0
0x302e,0x00, // EXTS
...
static unsigned short ov2675_init_reg_short0ddkandy[]={
0x3012 ,0x80,
0x308c ,0x80,
0x308d ,0x0e,
0x360b ,0x00,
...
0x3090, 0x03,///
	...
	static unsigned short ov2675_init_reg_short0svnraw[]={///other prj ,640x480
0x3012,0x80,//software reset
0x308c,0x80,
0x308d,0x0e,
0x360b,0x00,
...
//Lens correction
///0x3090,0x33, ///up-down ok,crystal.wang
///0x3090,0x3B, ///up-down ok,crystal.wang
///0x307c,0x11,
...
//
static unsigned short ov2675_init_reg_short0svnnow[]={///other prj ,640x480	
0x3012,0x80,//software reset
0x308c,0x80,
0x308d,0x0e,
0x360b,0x00,
...
static unsigned short ov2675_init_reg_short0prev_havebalcksreen[]={///
0x3012,0x80,
0x308c,0x80,
0x308d,0x0e,
0x360b,0x00,
...
static unsigned short ov2675_init_reg_short0C800600[]={///C800600
0x3012,0x80,//software reset
0x308c,0x80,
0x308d,0x0e,
0x360b,0x00,
...
static unsigned short ov2675_init_reg_short0youjian[]={///lanwan2youjianVGA
	0x3012,0x80,
//;IO & Clock & Analog Setup
0x308c,0x80,
0x308d,0x0e,
...
static unsigned short ov2675_init_reg_short0C[]={	///CELLON
//IO & Clock & Analog Setup
{0x308c,0x80},
{0x308d,0x0e},
{0x360b,0x00},
...
{0x3086,0x00},
	...
	static unsigned short ov2675_init_reg_short1_old[]={	
	// Start T&P part
...
static unsigned short ov2675_init_reg_short1[]={	
...
// End T&P part
	...
	static unsigned short ov2675_init_reg_short2[]={		
	//============================================================
...
static unsigned short ov2675_init_reg_short3[]={	
	//============================================================
...
static unsigned short ov2675_init_reg_short4[]={		
	...
	static unsigned short ov2675_init_reg_short4_2[]={		
	...
	static unsigned short ov2675_init_reg_short5_old[]={	
	//#================================================================================================
	//#SET CCM
	//#================================================================================================ 
...
static unsigned short ov2675_init_reg_short5[]={	
//#================================================================================================
//#SET CCM
//#================================================================================================ 
//#CCM start address //#7000_33A4
...
static unsigned short ov2675_init_reg_short6[]={		
...
static unsigned short ov2675_init_reg_short7[]={		
...
static unsigned short ov2675_init_reg_short8[]={	
#if 0	
	//================================================================================================
	// SET PLL
	//================================================================================================
...
static unsigned short ov2675_init_reg_short8_1_2048x1536[]={	
...
static unsigned short ov2675_init_reg_short8_1_1280x720[]={	
...
static unsigned short ov2675_init_reg_short8_1280x720[]={	
//================================================================================================
...
static unsigned short ov2675_init_reg_short8_640x480[]={	
//================================================================================================
// SET PREVIEW CONFIGURATION_0
// # Foramt : YUV422
// # Size: HD
...
static unsigned short ov2675_init_reg_short8_800x480[]={	
//================================================================================================
// SET PREVIEW CONFIGURATION_0
// # Foramt : YUV422
// # Size: HD
...
static unsigned short ov2675_init_reg_short8_640x480_old[]={	
	//================================================================================================
	// SET PREVIEW CONFIGURATION_0
	// # Foramt : YUV422
	// # Size: VGA
...
static unsigned short ov2675_init_reg_short8_1000x562[]={	
	//================================================================================================
	// SET PREVIEW CONFIGURATION_0
	// # Foramt : YUV422
	// # Size: VGA
...
static unsigned short ov2675_init_reg_short9[]={	
...
// capture preset
static unsigned short  ov2675_capture_preset_0[] = { 
...
static unsigned short ov2675_preview_preset_0[]={	///modified crystal 
         0x3012, 0x10, 
         0x302a, 0x02, 
         0x302b, 0xE6, 
         0x306f, 0x14, 
...
static unsigned short ov2675_preview_preset_1000x562[]={	
...
static unsigned short ov2675_movie_preset_0[]={	///modified crystal
	0x3012, 0x00 ,
	0x302a, 0x05 ,
	0x302b ,0xCB ,
	0x306f ,0x54 ,
...
static unsigned short ov2675_preview_preset_800x480[]={	
	// Select and apply preview configuration
...
static unsigned short ov2675_capture_jpeg_2048x1536[]={	
	//This code is for 3M Full YUV Capture Mode.
	//If you want initial(Preview)mode, comment below code.
	0x0028 ,0x7000,
	0x002A ,0x0388,
...
static unsigned short ov2675_capture_jpeg_2048x1536_off[]={	
	//This code is for 3M Full YUV Capture Mode.
	//If you want initial(Preview)mode, comment below code.
	0x0028 ,0x7000,
	0x002A ,0x0388,
...
static unsigned short ov2675_preview_on[]={
	// Select and apply preview configuration
...
static unsigned short ov2675_preview_off[]={
	// Select and apply preview configuration
...
static const  unsigned short *ov2675_regs_ev_bias3[] = { ///modified by crystal ,

	 (unsigned short *)ov2675_ev_m3,
	(unsigned short *)ov2675_ev_m2, (unsigned short *)ov2675_ev_m1,
	(unsigned short *)ov2675_ev_default, (unsigned short *)ov2675_ev_p1,
	(unsigned short *)ov2675_ev_p2, (unsigned short *)ov2675_ev_p3,
...
unsigned short ov2675_zoom_fixed[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short ov2675_zoom_infinity[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short ov2675_zoom_macro[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
unsigned short ov2675_focus_init[][4] = {
		0x0028, 0x7000,
		0x002A, 0x0254, //REG_TC_AF_AfCmdParam
		0x0F12, 0x0000, //write lens position from 0000 to 00FF. 
				  //0000 means infinity and 00FF means macro
...
static const unsigned short *ov2675_regs_focus[] = {
	(unsigned short *)ov2675_focus_auto,
	(unsigned short *)ov2675_zoom_fixed,
	(unsigned short *)ov2675_zoom_infinity,
	(unsigned short *)ov2675_zoom_macro,
	(unsigned short *)ov2675_focus_init,
};
...
static unsigned short ov2675_wb_daylght[] = {
		0x3306 ,0x02,
              	0x3337, 0x68,
              	0x3338 ,0x40,
               	0x3339 ,0x4E,
...
static const unsigned char *ov2675_regs_sharpness_bias[] = {
	(unsigned char *)ov2675_sharpness_m2,
	(unsigned char *)ov2675_sharpness_m1,
	(unsigned char *)ov2675_sharpness_default,
	(unsigned char *)ov2675_sharpness_p1,
	(unsigned char *)ov2675_sharpness_p2,
};
