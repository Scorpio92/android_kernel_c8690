...
static int ov2675_write_array(struct v4l2_subdev *sd,const unsigned  short * reg , int size)
{	
...
//	v4l_info(client, "%s: camera initialization start\n", __func__);
	err=ov2675_write_array(sd,ov2675_init_reg_short0,2);mdelay(6);
	err=ov2675_write_array(sd,&ov2675_init_reg_short0[2],ov2675_INIT_REGS0-2);
