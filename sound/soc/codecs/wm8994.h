...
#endif
//For testing WM8994 by read and write register.--tab.wang START//
#define WM8994_IOCTL_MAGIC ';'

#define WM8994_READ_REG		_IOR(WM8994_IOCTL_MAGIC, 1, unsigned long)
#define WM8994_WRITE_REG		_IOW(WM8994_IOCTL_MAGIC, 2, unsigned long)
//For testing WM8994 by read and write register.--tab.wang END//
#endif
