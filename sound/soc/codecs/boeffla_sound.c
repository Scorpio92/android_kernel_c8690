...
bool check_for_dapm_boeffla(enum snd_soc_dapm_type dapm_type, char* widget_name)
{
...
// if no fm radio built in, always set to false
	...
	return check_for_dapm_boeffla(snd_soc_dapm_line, "FM In");
#else
	return false;
#endif
}
...
{
	return check_for_dapm_boeffla(snd_soc_dapm_spk, "RCV");
}
...
// different headphone detection for s3 devices and note devices
	...
	return false;
#else
	return check_for_dapm_boeffla(snd_soc_dapm_hp, "HP");
#endif
}
