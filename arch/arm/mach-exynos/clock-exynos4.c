...
static u32 epll_div[][6] = {
	...
	//{  32768000, 0, 131, 3, 5, 4719 },		// zsb
	//{  16384000, 0, 131, 3, 6, 4719 },		// zsb
};
...
void __init_or_cpufreq exynos4_setup_clocks(void)
{
	...
	/* For debugging */
#if 0//zxz for isp
	printk(KERN_INFO "FIMC-IS CLK_DIV_TOP = 0x%08x\n",
					__raw_readl(EXYNOS4_CLKDIV_TOP));
	
	printk(KERN_INFO "FIMC-IS CLK SRC TOP0 = 0x%08x,TOP1 = 0x%08x\n",
					__raw_readl(EXYNOS4_CLKSRC_TOP0),
