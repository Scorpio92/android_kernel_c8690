...
//Cellon add start, zepeng.wu, 2012/10/31, for TP power
  struct regulator *vdd28_af_regulator;
	...
	out:
//Cellon add end, zepeng.wu, 2012/10/31, for TP power
...
//Cellon modify begin , charles.hu 2012/10/31
		
//		if (!regulator_is_enabled(vdd18_a31_regulator))
//			regulator_enable(vdd18_a31_regulator);

//Cellon modify end   , charles.hu 2012/10/31
