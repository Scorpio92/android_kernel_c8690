...
//Cellon modify start, Jacob, 2012/07/29, for request display issue
...
//	.esc_clk = 1000000,	/* escape clk : 10MHz */
// Cellon modify end, Jacob, 2012/07/29
	...
	.e_lane_swap = DSIM_NO_CHANGE,// DSIM_NO_CHANGE,
};
...
static struct dsim_lcd_config dsim_lcd_info = {
	...
	.parameter[DSI_VIDEO_MODE_SEL]	= (unsigned int)DSIM_BURST, //DSIM_NON_BURST_SYNC_PULSE,//DSIM_NON_BURST_SYNC_EVENT,//DSIM_NON_BURST_SYNC_PULSE,
