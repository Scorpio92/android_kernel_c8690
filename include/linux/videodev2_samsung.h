...
#define V4L2_CID_CAMERA_CONTINUOUS_FLAG   (V4L2_CID_PRIVATE_BASE + 52)//add_lzy
#define V4L2_CID_CAMERA_CONTINUOUS_GETJPEGSIZE  (V4L2_CID_PRIVATE_BASE + 61)//add_lzy
...
#define V4L2_CID_CAMERA_EXPOSURE (V4L2_CID_PRIVATE_BASE+127)
...
#define V4L2_CID_CAMERA_TORCH_MODE      (V4L2_CID_PRIVATE_BASE+128)
enum v4l2_torch_mode
{
    TORCH_MODE_PICTURE,
    TORCH_MODE_RECORD,
    TORCH_MODE_FLASHLIGHT,
};


//Cellon add begin , charles.hu 2012/09/10
#define V4L2_CID_CAMERA_SMILE_SHUTTER              (V4L2_CID_PRIVATE_BASE+129)
typedef enum{
	SMILE_SHUTTER_OFF,
	SMILE_SHUTTER_ON,	
}smile_shutter_mode_t;

#define V4L2_CID_CAMERA_SMILE_SHUTTER_RESULT             (V4L2_CID_PRIVATE_BASE+130)
//Cellon add end   , charles.hu 2012/09/10

//Cellon add begin , charles.hu 2012/09/18
#define V4L2_CID_CAMERA_MULTI_CAPTRUE              (V4L2_CID_PRIVATE_BASE+131)
typedef enum{
	MULTI_CAPTRUE_OFF,
	MULTI_CAPTRUE_ON,	
}multi_captrue_mode_t;
//Cellon add end   , charles.hu 2012/09/18

#define V4L2_CID_AF_LOST_STATE 		(V4L2_CID_PRIVATE_BASE+132)
